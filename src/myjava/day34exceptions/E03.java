package myjava.day34exceptions;
...
public class E03 {
	...
	public static int getNumOfChars(String s) {
		...
		}catch(NullPointerException e) { //"NullPointerException" String class'da "null" ile uyumlu olmayan 
			                              //method'lar kullanildiginda atilir.
   ...
   //e.getMessage() yaptigimizda java kendi teknik mesajini verir.
   //e.  yaptigimizda methodlarini kullanabiliriz.
