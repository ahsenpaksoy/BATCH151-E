package myjava.day28interface;

public interface Animal {

	void eat(); //bu method, yazilmasa da public ve abstract'tir.
	
	void drink();
	
	//1)interface'lerdeki tum variable'lar otomatik(default) olarak "final"dir.
	//Baslatilmasi ve degistirilmemesi gerekir.
    //  Bu yuzden interface icindeki variable'i olusturdugunuzda mutlaka deger 
	//atamasi yapmalisiniz.
...
//parent'daki abstract method'u kullanma zorunlulugu, concrete child class'lar 
//icin gecerli.
